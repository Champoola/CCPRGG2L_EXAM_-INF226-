...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^(?=.*[0-9])(?!.*[frFR]).{6,}$");
        ...
        pattern = Pattern.compile("^(?=.{10,})[\\\\w\\\\.]{2,}@gmail\\\\.com");
        ...
        String firstname = "Dhan";
        String lastname = "Ferrer";
        // Provide regex pattern
        pattern = Pattern.compile("^(https?://)?" + "(www\\.)?" +
                "[a-zA-Z]" + firstname + "\\-" + lastname + "\\.[a-z]+" + "(/.*)?$");
        ...
        // Provide regex pattern
        pattern = Pattern
        			.compile("(?!\\w+\\.(java|py|cpp))\\w+\\.[a-zA-Z]+");
